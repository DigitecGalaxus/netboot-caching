...
mount -o defaults,nofail /dev/vda2 /home/master/netboot/assets
mount -o defaults,nofail /dev/sda2 /home/master/netboot/assets
mount -o defaults,nofail /dev/nvme0n1p2 /home/master/netboot/assets
...
mount -o defaults,nofail /dev/vda1 /home/master/netboot/assets/caching-server
mount -o defaults,nofail /dev/sda1 /home/master/netboot/assets/caching-server
mount -o defaults,nofail /dev/nvme0n1p1 /home/master/netboot/assets/caching-server
